...
Undirritaður hefur nú þegar unnið úr ráðningargögnum úr töflum VIN01110 (starfandi eftir atvinnugreinum) og VIN01100 (starfandi eftir starfsgreinum) úr PxWeb-gagnagrunni Hagstofunnar. Gögn um laus störf myndu ljúka myndinni af eftirspurn á vinnumarkaði og sýna hvort atvinnugreinar sem draga úr ráðningum séu einnig að draga úr ráðningarvilja.

Þetta er hluti af rannsóknarverkefni í framhaldi af meistaragráðu við Háskólann á Akureyri sem kannar mælingarhæfni íslenskra stofnana gagnvart áhrifum tæknibreytinga á vinnumarkaðinn. Rannsóknin hefur leitt í ljós merki um að upplýsingatæknigeirinn (NACE J) sýnir samtímis samdrátt í ráðningum (-11,4%), aukningu í tekjum (+72%) og hrun í lausum störfum (5,4% niður í 0,3%) — mynstur sem enginn íslenskur aðili hafði tengt saman áður.

**Umbeðin gögn**
Óskað er eftir eftirfarandi gögnum, ársfjórðungslega frá 1. ársfjórðungi 2022 til 4. ársfjórðungs 2025:
1. **Fjöldi lausra starfa** eftir ÍSAT-atvinnugreinaflokkum (A til U).
2. **Hlutfall lausra starfa** eftir atvinnugreinaflokkum ef tiltækt (laus störf / (skipuð störf + laus störf)).

*Athugasemd: Ef þessi gögn eru nú þegar aðgengileg í gegnum PxWeb og ég hef ekki fundið þau, væri ég afar þakklátur fyrir vísun á rétt töflunúmer.*
...
**Snið (ef vinna þarf gögnin)**
CSV eða Excel er æskilegt, til dæmis með eftirfarandi uppbyggingu:

| Ársfjórðungur | ÍSAT-flokkur | Laus störf (fjöldi) | Hlutfall lausra starfa |
| :--- | :--- | :--- | :--- |
| 2022-F1 | J | [n] | [n]% |
